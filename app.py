...
def preprocess(user_symptoms):
    df_comb = pd.read_csv(r"/home/munavvarsinan/Documents/project-final/MediCURE-Disease-Prediction-based-on-Symptoms/Dataset/dis_sym_dataset_comb.csv") # Disease combination
    df_norm = pd.read_csv(r"/home/munavvarsinan/Documents/project-final/MediCURE-Disease-Prediction-based-on-Symptoms/Dataset/dis_sym_dataset_norm.csv") # Individual Disease
...
def predict():
    ...
    tup = dict_symp_tup[-1] if dict_symp_tup else None
...
def final():
    ...
    my_model=pickle.load(open(r'/home/munavvarsinan/Documents/project-final/MediCURE-Disease-Prediction-based-on-Symptoms/model_saved','rb'))
...
def treatment():
    ...
    workbook = openpyxl.load_workbook(r'/home/munavvarsinan/Documents/project-final/MediCURE-Disease-Prediction-based-on-Symptoms/cure_minor.xlsx')
